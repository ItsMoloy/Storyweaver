...
const BookDetails = () => {
    ...
    const fetchSamplePages = async () => {
        try {
            const response = await fetch(`https://openlibrary.org/api/books?bibkeys=ISBN:${978-1-60309-502-0}&jscmd=data&format=json`);
            const data = await response.json();

            const bookData = data[`ISBN:${978-1-60309-502-0}`];
