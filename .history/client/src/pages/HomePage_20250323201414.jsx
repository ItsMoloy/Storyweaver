...
const dummyBooks = [
    ...
    { id: 2, title: "To Kill a Mockingbird", category: "Fiction", photo: require("../assets/books/gatsby.jpg")", price: 15 },
    { id: 3, title: "1984", category: "Dystopian", photo: require("../assets/books/gatsby.jpg"), price: 20 },
    { id: 4, title: "The Catcher in the Rye", category: "Classic", photo: require("../assets/books/gatsby.jpg")", price: 12 },
    { id: 5, title: "Moby-Dick", category: "Adventure", photo: require("../assets/books/gatsby.jpg"), price: 18 },
    { id: 6, title: "Pride and Prejudice", category: "Romance", photo: require("../assets/books/gatsby.jpg")", price: 14 },
];
